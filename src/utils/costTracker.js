...
function loadProviderPricingData(providerName) {
	...
	try {
		...
		// Look for {provider}-pricin.g.json in the config directory relative to this module.
 ...
 * Reloads OpenAI pricing data.
 *
 * @since 1.0.0
 * @deprecated Use reloadProviderPricingData('openai') instead
 *
 * @return {Object} Reloaded OpenAI pricing data
 */
export function reloadPricingData() {
	return reloadProviderPricingData('openai');
}
